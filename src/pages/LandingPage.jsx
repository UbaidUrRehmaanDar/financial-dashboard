  ...
  return (
    <div className="min-h-screen animated-gradient text-foreground relative overflow-hidden">
      ...
      <motion.div
        ...
        animate={{ scale: [1, 1.15, 1], rotate: [0, 45, 0], opacity: [0.3, 0.5, 0.3] }}
      ...
      <section className="pt-32 pb-24 px-6 max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <Button variant="outline" onClick={() => { window.location.hash = 'market'; }}>
            Explore Demo
          </Button>
        </motion.div>
      </section>
            ...
            >
              <Card className="card-premium p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className={`flex items-center gap-1 ${mover.isUp ? 'text-emerald-500' : 'text-rose-500'}`}>
